    ...
    <Layout onLoginRequest={onLoginRequest}>
      ...
      <section className="page-section page-section--mb section-reveal">
        <div className="page-doc">
          ...
          <p>
            Each tenant&#39;s data, including projects, generated assets, run history, and sourced
            leads, is scoped to that tenant and is not shared with other tenants. We process it to
            run your pipeline: producing content, scoring leads, and executing approved outreach.
          </p>
